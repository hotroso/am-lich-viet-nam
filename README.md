...
| 🔔 **Nhắc nhiều mốc** | Đặt nhiều lần nhắc trước (30 ngày, 7 ngày, 1 ngày...) cho 1 sự kiện, mỗi mốc kèm ghi chú riêng (VD: "Mua vé máy bay", "Chuẩn bị đồ cúng") |
...
| Phiên bản Web (PWA) | [amlich.hotrogiaiphapso.info](https://amlich.hotrogiaiphapso.info/) |

> Quét mã QR trên trang Release để tải trực tiếp về điện thoại.

## 🌐 Phiên bản Web

Ngoài bản Android, ứng dụng còn có phiên bản **Progressive Web App (PWA)** chạy trực tiếp trên trình duyệt, hỗ trợ mọi nền tảng (iOS, Android, Desktop):

👉 **[https://amlich.hotrogiaiphapso.info/](https://amlich.hotrogiaiphapso.info/)**

- Giao diện giống bản Android native
- Hoạt động offline sau lần truy cập đầu tiên
- Cài về Màn hình chính để dùng như app
- Hỗ trợ Safari iOS, Chrome, Firefox, Edge
- Mã nguồn: [nhánh `webapp`](https://github.com/hotroso/am-lich-viet-nam/tree/webapp)
